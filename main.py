...
def begin_query(context):
    ...
    switch = {
        'Single_PT': PkgAlg.run_Single_PT,
        'Single_GT': PkgAlg.run_Single_GT,
        'Single_GA': PkgAlg.run_single_GA,
        'Single_MA': PkgAlg.run_Single_MA,
        'Single_MA_CDLS': PkgAlg.run_Single_MA_CDLS,
        'Multi_PT': PkgAlg.run_Multi_PT,
        'Multi_GT': PkgAlg.run_Multi_GT,
        'Multi_GA': PkgAlg.run_Multi_GA,
        'Multi_MA': PkgAlg.run_Multi_MA,
        'Multi_MA_CDLS': PkgAlg.run_Multi_MA_CDLS
    }
