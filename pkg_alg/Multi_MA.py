...
class MA_Multi(object):
    ...
    def memetic(self):
        ...
        for i in meme_idx:
            ...
            arg_f1 = self.parent_f1_array[i]
            arg_f2 = self.parent_f2_array[i]
            ...
            for n in np.arange(len_nei):
                nei_f1, nei_f2 = compute_fitness(self, neighbour[n])
                if nei_f1 <= arg_f1 and nei_f2 <= arg_f2:
                    if nei_f1 != arg_f1 and nei_f2 != arg_f2:
                        self.parent[i] = neighbour[n]
